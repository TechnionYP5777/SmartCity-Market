...
public class SQLDatabaseStrings {
	...
	public static class MANUFACTURER_TABLE {
		//table name 
		public static final String MANUFACTURER_TABLE = "ManufcaturerTable";
	...
	public static class PRODUCTS_CATALOG_TABLE {
		...
		public static final String ATTR_MANUFACTURER_ID = 
				MANUFACTURER_TABLE.ATTR_MANUFACTURER_ID;
	...
	public static class PRODUCTS_CATALOG_INGREDIENTS_TABLE {
		//table name 
		public static final String PRODUCTS_CATALOG_INGREDIENTS_TABLE = 
				"ProductsCatalogIngredientsTable";
		
		//table attributes
		public static final String ATTR_BARCODE = PRODUCTS_CATALOG_TABLE.ATTR_BARCODE;
		public static final String ATTR_INGREDIENT_ID = 
				INGREDIENTS_TABLE.ATTR_INGREDIENT_ID;
	}
	...
	public static class PRODUCTS_CATALOG_LOCATIONS_TABLE {
		//table name 
		public static final String PRODUCTS_CATALOG_LOCATIONS_TABLE = 
				"ProductsCatalogLocationsTable";
		
		//table attributes
		public static final String ATTR_BARCODE = PRODUCTS_CATALOG_TABLE.ATTR_BARCODE;
		public static final String ATTR_LOCATION_ID = 
				LOCATIONS_TABLE.ATTR_LOCATION_ID;
	}
	...
	public static class PRODUCTS_PACKAGES_TABLE {
		//table name 
		public static final String PRODUCTS_PACKAGES_TABLE = 
				"ProductsPackagesTable";
	...
	public static class GROCERIES_LISTS_HISTORY_TABLE {
		//table name 
		public static final String GROCERIES_LISTS_HISTORY_TABLE = 
				"GroceriesListsHistoryTable";
