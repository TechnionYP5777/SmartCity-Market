...
public class SmartcodeParser {
	...
	/**
	 * return the code class character according to the character index (in Code 128)
	 * 
	 * @param index
	 * @return
	 */
	...
	private static class Code128Char{
		...
		String character;
		/**
		 * binary code representation as strikes of black (1) and white (0), like: 11110010010
		 */
		String binaryCode;
		/**
		 * binary code representation as width of black rectangles (the one in the even position)
		 * and width of white rectangles (the one in the odd position), like: 421211
		 */
		@SuppressWarnings("unused")
		String widthCode;
