...
public class GetSalesForProductTest {
	...
	@Test
	public void GetForgotPasswordQuestionSuccessfulTest() {
		try {
	...
	@Test
	public void GetForgotPasswordQuestionCriticalErrorTest() {
		try {
			Mockito.when(clientRequestHandler.sendRequestWithRespond(
					new CommandWrapper(CustomerDefs.loginCommandSenderId, CommandDescriptor.GET_SALE_FOR_PRODUCT,
							Serialization.serialize(barcode)).serialize()))
	...
	@Test
	public void GetForgotPasswordQuestionCustomerNotConnectedTest() {
		try {
			Mockito.when(clientRequestHandler.sendRequestWithRespond(
					new CommandWrapper(CustomerDefs.loginCommandSenderId, CommandDescriptor.GET_SALE_FOR_PRODUCT,
							Serialization.serialize(barcode)).serialize()))
	...
	@Test
	public void GetForgotPasswordQuestionProductCatalogDoesNotExistTest() {
		try {
			Mockito.when(clientRequestHandler.sendRequestWithRespond(
					new CommandWrapper(CustomerDefs.loginCommandSenderId, CommandDescriptor.GET_SALE_FOR_PRODUCT,
							Serialization.serialize(barcode)).serialize()))
	...
	@Test
	public void GetForgotPasswordQuestionInvalidParameterTest() {
		try {
			Mockito.when(clientRequestHandler.sendRequestWithRespond(
					new CommandWrapper(CustomerDefs.loginCommandSenderId, CommandDescriptor.GET_SALE_FOR_PRODUCT,
							Serialization.serialize(barcode)).serialize()))
